...
const FirstTimeWelcome2 = ({ navigation }) => {
        ...
        <SafeAreaView style={styles.container}>
            ...
            >
                <ScrollView contentContainerStyle={styles.scroller}>
                    ...
                    <View style={{ borderColor: 'grey', borderWidth: 1, borderRadius: 8, padding: 10, marginTop: 20 }}>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', fontWeight: 'bold' }}>
                            <Text style={{ fontSize: 22, fontWeight: 'bold' }}>Transaction History</Text>
                            <Text style={{ fontSize: 16, textDecorationLine: 'underline', fontWeight: 'bold' }}>See All</Text>
                        </View>
                ...
                <View style={styles.footer}>
                    ...
                    <TouchableOpacity onPress={goToKyc}>
                        <View style={styles.tabview}>
                            <Image
                                style={{ width: 28, height: 28, marginTop: 3 }}
...
export default FirstTimeWelcome2;
