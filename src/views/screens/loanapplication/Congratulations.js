      ...
      >
        <ScrollView>
          <View style={styles.firstFlex}>
            ...
            <Text style={styles.successtextbig}>Congratulations</Text>
            <Text style={styles.successtextsmall}>
              You have successfully applied for this loan, we will notify you
              once your loan has been approved and when the funds is sent to
              your wallet.
            </Text>
          </View>
