    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <ScrollView contentContainerStyle={styles.scroller}>
          ...
          >
            <Image
              source={require("../../../../assets/handpencil.png")}
              style={{ width: 187, height: 111 }}
              resizeMode="contain"
            />

            <Text style={styles.txtInstuct}>
              Click the button below to generate a temporal account number to
              make payment to. Note, you will have to upload payment proof when
              you are done.
            </Text>
          </View>
          <TouchableOpacity
            onPress={() => navigation.navigate("RepayLoanB")}
            activeOpacity={0.7}
            style={styles.btn}
          >
            <Text style={styles.btnText}>Generate Account Number</Text>
            <Image
