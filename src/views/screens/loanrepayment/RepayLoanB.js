      ...
      >
        <ScrollView contentContainerStyle={styles.scroller}>
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <TouchableOpacity
                onPress={() => navigation.navigate("RepayLoanA")}
          ...
          >
            <Text style={styles.txtInstuctA}>1099029187</Text>
            <Text style={styles.txtInstuctB}>FTL-Wave | Wisrod Lending</Text>
            <Text style={styles.txtInstuctC}>Flutterwave MFB</Text>
          </View>
          <TouchableOpacity
            onPress={() => navigation.navigate("RepayLoanD")}
            activeOpacity={0.7}
            style={styles.btn}
          >
            <Text style={styles.btnText}>I have made payment</Text>
            <Image
