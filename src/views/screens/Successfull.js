      ...
      >
        <ScrollView>
          <View style={styles.firstFlex}>
            ...
            <Text style={styles.successtextbig}>Onboarding is Successful</Text>
            <Text style={styles.successtextsmall}>
              Your account creation is successful, you can now proceed to enjoy
              all the amazing feature we have on WISROD!.
            </Text>
          </View>
