...
const MarketSuccessfull = ({ navigation, props }) => {
  ...
  useEffect(() => {
    const asyncFetch = async () => {
      const amount = await AsyncStorage.getItem("TOKEN");
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.firstFlex}>
          ...
          <Text style={styles.successtextbig}>Successful!</Text>
          <Text style={styles.successtextsmall}>
            You have sucessfully funded an account with ${funded}
          </Text>
        </View>
...
export default MarketSuccessfull;
