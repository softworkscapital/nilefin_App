  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.firstFlex}>
        ...
        <Text style={styles.successtextbig}>KYC Completed</Text>
        <Text style={styles.successtextsmall}>
        You have successfully completed your KYC uploads, we will let you know once all document is approved. You can now proceed to apply for loans.
        </Text>
      </View>
